      ...
      <div className="py-2 flex-1 flex flex-col items-start justify-center gap-4 md:gap-6">
        ...
        <div className="flex gap-3">
          ...
          <motion.p
            ...
            className="flex items-center gap-1 bg-gradient-to-br from-orange-300 to-orange-500 px-3 py-2 rounded-lg hover:shadow-lg cursor-pointer"
          >
            Order Now <MdShoppingBasket />
          </motion.p>
          <motion.p
            whileTap={{ scale: 0.75 }}
            className="flex items-center gap-1 bg-gradient-to-br from-orange-300 to-orange-500 px-4 py-2 rounded-lg hover:shadow-lg cursor-pointer"
            onClick={login}
          >
            Sign In <MdLogin />
          </motion.p>
