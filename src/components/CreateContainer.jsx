    ...
    <div className="w-full min-h-screen h-auto flex items-center justify-center">
      <div className="w-[90%] md:w-[75%] border border-gray-200 rounded-lg p-4 flex flex-col items-center justify-center gap-4">
        ...
        <div className="w-full">
          ...
          >
            <option value="other" className="bg-white font-semiBold">
              Select Category
            </option>
            {categories &&
              categories.map((item) => (
        ...
        <div className="group flex justify-center items-center flex-col border-2 border-dooted border-gray-200 w-full h-225 md:h-420 cursor-pointer rounded-lg">
          {isLoading ? (
            <Loader />
          ) : (
            <>
        ...
        <div className="w-ull flex flex-col md:flex-row items-center gap-3">
          <div className="w-full py-2 border-b border-gray-300 flex items-center gap-2">
          ...
          <div className="w-full py-2 border-b border-gray-300 flex items-center gap-2">
            <MdPaid className="text-gray-700 text-2xl" />
            <input
              type="text"
              value={price}
